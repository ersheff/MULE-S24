...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1029.0, 799.0, 73.0, 22.0 ],
					"text" : "jit.ndi.send~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1293.0, 536.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 805.0, 512.0, 150.0, 20.0 ],
					"text" : "<-- 3. start video"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1345.0, 545.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 818.0, 487.0, 150.0, 20.0 ],
					"text" : "<-- 2. open camera"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1330.0, 530.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 925.0, 463.0, 150.0, 20.0 ],
					"text" : "<-- 1. choose camera"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1378.0, 387.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 776.0, 439.0, 150.0, 20.0 ],
					"text" : "Video tester"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1112.0, 640.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 779.0, 510.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1298.0, 727.0, 65.0, 22.0 ],
					"text" : "getvdevlist"
				}
...
,
					"patching_rect" : [ 1358.0, 799.0, 159.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1358.0, 896.0, 68.0, 22.0 ],
					"text" : "vdevice $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1358.0, 827.0, 145.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 778.0, 462.0, 145.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1064.0, 685.0, 38.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 778.0, 486.0, 38.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1112.0, 685.0, 77.0, 22.0 ],
					"text" : "qmetro 30Hz"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1112.0, 767.0, 45.0, 22.0 ],
					"text" : "jit.grab"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1112.0, 799.0, 240.0, 135.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 779.0, 536.0, 240.0, 135.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 727.0, 633.0, 40.0, 22.0 ],
					"text" : "* 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "float", "", "", "" ],
					"patching_rect" : [ 727.0, 603.0, 89.0, 22.0 ],
					"text" : "unpack 0. s s s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 693.0, 528.0, 44.0, 22.0 ],
					"text" : "scan 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 693.0, 568.0, 53.0, 22.0 ],
					"text" : "vstscan"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 312.0, 603.0, 39.0, 22.0 ],
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 517.0, 425.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 425.0, 83.0, 22.0 ],
					"text" : "loadmess 120"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 278.0, 566.0, 53.0, 22.0 ],
					"text" : "link.beat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 10.0, 666.0, 34.0, 22.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 10.0, 604.0, 66.0, 22.0 ],
					"text" : "cycle~ 440"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 467.0, 83.0, 22.0 ],
					"text" : "loadmess 440"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 1119.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1367.5, 948.5, 1102.0, 948.5, 1102.0, 756.5, 1121.5, 756.5 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1147.5, 794.0, 1367.5, 794.0 ],
					"source" : [ "obj-95", 1 ]
				}
